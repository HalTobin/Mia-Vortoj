...
data class Language(
    ...
    companion object {
        val languagesList = listOf(
            ...
            Language("Italiano", "ITA", R.drawable.flag_simple_it, R.string.language_ita,0xFF49946D,0xFF016330, false),
            Language("Sard", "SRD", R.drawable.flag_simple_it88, R.string.language_srd,0xFFFFFFFF,0xFF8D0F14, false),
            Language("Română", "RUM", R.drawable.flag_simple_ro, R.string.language_rum,0xFFFFED74,0xFF851309, false),

            Language("English", "ENG", R.drawable.flag_simple_gb, R.string.language_eng,0xFF5876C2, 0xFF00247D,false, Locale.ENGLISH),
            Language("Scots", "SCO", R.drawable.flag_simple_gd, R.string.language_sco,0xFF49A6FF, 0xFF003E79,false),

            Language("Nederlands", "NLD", R.drawable.flag_simple_nl, R.string.language_nl,0xFF3166C9, 0xFF214485,false, Locale("nl")),
            Language("Frysk", "FRY", R.drawable.flag_simple_fry, R.string.language_fry,0xFF4A92D6, 0xFF00407E,false),
            Language("Nordfriisk", "FRR", R.drawable.flag_simple_frr, R.string.language_frr,0xFF2C67DF, 0xFF062A74,false),
